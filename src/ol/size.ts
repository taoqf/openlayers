 ...
 */
export function buffer(size: Size, num: number, opt_size?: Size) {
 ...
 */
export function hasArea(size: Size) {
 ...
 */
export function scale(size: Size, ratio: number, opt_size?: Size) {
	if (opt_size === undefined) {
		opt_size = [0, 0];
	}
 ...
 * @api
 */
export function toSize(size: number | Size, opt_size?: Size) {
