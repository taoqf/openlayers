 ...
 * @api
 */
export function add(coordinate: Coordinate, delta: Coordinate) {
 ...
 */
export function closestOnSegment(coordinate: Coordinate, segment: [Coordinate, Coordinate]): Coordinate {
 ...
 * @api
 */
export function createStringXY(opt_fractionDigits = 0) {
	/**
	 * @param {module:ol/coordinate~Coordinate} coordinate Coordinate.
 ...
 */
export function degreesToStringHDMS(hemispheres: string, degrees: number, opt_fractionDigits = 0) {
 ...
 * @api
 */
export function format(coordinate: Coordinate, template: string, opt_fractionDigits = 0) {
	if (coordinate) {
		return template
 ...
 */
export function equals(coordinate1: Coordinate, coordinate2: Coordinate) {
 ...
 * @api
 */
export function rotate(coordinate: Coordinate, angle: number) {
 ...
 *
 * @param {module:ol/coordinate~Coordinate} coordinate Coordinate.
 * @param {number} scal Scale factor.
 * @return {module:ol/coordinate~Coordinate} Coordinate.
 */
export function scale(coordinate: Coordinate, scal: number) {
	coordinate[0] *= scal;
	coordinate[1] *= scal;
	return coordinate;
}
 ...
 */
export function squaredDistance(coord1: Coordinate, coord2: Coordinate) {
 ...
 */
export function squaredDistanceToSegment(coordinate: Coordinate, segment: [Coordinate, Coordinate]) {
 ...
 * @api
 */
export function toStringHDMS(coordinate: Coordinate, opt_fractionDigits = 0) {
	if (coordinate) {
 ...
 * @api
 */
export function toStringXY(coordinate: Coordinate, opt_fractionDigits = 0) {
