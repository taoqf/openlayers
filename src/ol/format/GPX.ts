...
import {transformWithOptions} from '../format/Feature';
import XMLFeature from '../format/XMLFeature';
import {readString, readDecimal, readNonNegativeInteger, readDateTime, writeStringTextNode, writeNonNegativeIntegerTextNode, writeDecimalTextNode, writeDateTimeTextNode} from '../format/xsd';
...
import {createElementNS, makeArrayPusher, makeArraySerializer, makeChildAppender,
  ...
  XML_SCHEMA_INSTANCE_URI} from '../xml';
