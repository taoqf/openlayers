...
import {fragment, vertex} from '../webgl/defaultmapshader';
import Locations from '../webgl/defaultmapshader/Locations';
...
import {ARRAY_BUFFER, FRAMEBUFFER, FLOAT, TEXTURE_2D,
  TRIANGLE_STRIP, COLOR_ATTACHMENT0} from '../../webgl';
import WebGLBuffer from '../../webgl/Buffer';
import {createEmptyTexture} from '../../webgl/Context';
