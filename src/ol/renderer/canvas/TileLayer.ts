...
import {containsExtent, createEmpty, equals, getIntersection, isEmpty} from '../../extent';
import IntermediateCanvasRenderer from '../canvas/IntermediateCanvas';
import {create as createTransform, compose as composeTransform} from '../../transform';
