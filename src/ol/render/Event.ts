...
export default class RenderEvent extends Event {
	public vectorContext: VectorContext | undefined;
	public frameState: FrameState | undefined;
	public context: CanvasRenderingContext2D | undefined;
	public glContext: WebGLContext | undefined;
	constructor(type: string, opt_vectorContext?: VectorContext, opt_frameState?: FrameState, opt_context?: CanvasRenderingContext2D, opt_glContext?: WebGLContext) {
		super(type);
