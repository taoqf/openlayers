 ...
 */
export function reset(transform: Transform) {
 ...
 */
export function multiply(transform1: Transform, transform2: Transform) {
 ...
 */
export function set(transform: Transform, a: number, b: number, c: number, d: number, e: number, f: number) {
	transform[0] = a;
	transform[1] = b;
	transform[2] = c;
	transform[3] = d;
 ...
 */
export function setFromArray(transform1: Transform, transform2: Transform) {
 ...
 *     chained together.
 */
export function apply(transform: Transform, coordinate: Coordinate) {
 ...
 */
export function rotate(transform: Transform, angle: number) {
	const cos = Math.cos(angle);
	const sin = Math.sin(angle);
	return multiply(transform, set(tmp, cos, sin, -sin, cos, 0, 0));
}
 ...
 */
export function scale(transform: Transform, x: number, y: number) {
	return multiply(transform, set(tmp, x, 0, 0, y, 0, 0));
}
 ...
 */
export function translate(transform: Transform, dx: number, dy: number) {
	return multiply(transform, set(tmp, 1, 0, 0, 1, dx, dy));
}
 ...
 */
export function compose(transform: Transform, dx1: number, dy1: number, sx: number, sy: number, angle: number, dx2: number, dy2: number) {
	const sin = Math.sin(angle);
	const cos = Math.cos(angle);
	transform[0] = sx * cos;
	transform[1] = sy * sin;
 ...
 */
export function invert(transform: Transform) {
 ...
 */
export function determinant(mat: Transform) {
