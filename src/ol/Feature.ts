...
export default class Feature extends BaseObject {
	 ...
	 * @private
	 */
	private geometryName_ = 'geometry';
	 ...
	 */
	private style_: Style | Style[] | StyleFunction | null = null;
	 ...
	 */
	private geometryChangeKey_: EventsKey | null = null;
	constructor(opt_geometryOrProperties?: Geometry | { [s: string]: any; }) {
		super();
	 ...
	 * @observable
	 */
	public setGeometry(geometry: Geometry | undefined) {
	 ...
	 */
	public setStyle(style: Style | Style[] | StyleFunction) {
		this.style_ = style;
	 ...
	 * @fires module:ol/events/Event~Event#event:change
	 */
	public setId(id: number | string | undefined) {
		this.id_ = id;
		this.changed();
	}
	 ...
	 * @api
	 */
	public setGeometryName(name: string) {
		unlisten(
			this, getChangeEventType(this.geometryName_),
			this.handleGeometryChanged_, this);
 ...
 */
export function createStyleFunction(obj: StyleFunction | Style | Style[]) {
