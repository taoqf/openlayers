...
export default class Overlay extends BaseObject {
	...
	protected rendered: { bottom_: string; left_: string; right_: string; top_: string; visible: boolean; };
	...
	constructor(options: Partial<Options>) {
		 ...
		 */
		this.autoPanAnimation = options.autoPanAnimation || /** @type {module:ol/Overlay~PanOptions} */ ({} as PanOptions);
	 ...
	 * @api
	 */
	public setMap(map: PluggableMap | undefined) {
	 ...
	 * @api
	 */
	public setPosition(position: Coordinate | undefined) {
	 ...
	 * @api
	 */
	public setElement(element: Element | undefined) {
	 ...
	 * @api
	 */
	public setPositioning(positioning: OverlayPositioning) {
	 ...
	 * @protected
	 */
	protected getRect(element: Element, size: Size) {
	 ...
	 * @protected
	 */
	protected updateRenderedPosition(pixel: Pixel, mapSize: Size) {
