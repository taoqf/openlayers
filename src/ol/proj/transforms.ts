 ...
 */
let transforms = {} as { [code: string]: { [code: string]: TransformFunction; } };
 ...
 */
export function add(source: Projection, destination: Projection, transformFn: TransformFunction) {
 ...
 */
export function remove(source: Projection, destination: Projection) {
	const sourceCode = source.getCode();
	const destinationCode = destination.getCode();
 ...
 */
export function get(sourceCode: string, destinationCode: string) {
	let transform;
