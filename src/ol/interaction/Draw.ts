...
import {squaredDistance as squaredCoordinateDistance} from '../coordinate';
import {listen} from '../events';
import Event from '../events/Event';
import {noModifierKeys, always, shiftKeyOnly} from '../events/condition';
import {boundingExtent, getBottomLeft, getBottomRight, getTopLeft, getTopRight} from '../extent';
...
import {POINTER_TYPE} from '../pointer/MouseSource';
import Point from '../geom/Point';
import Polygon, {fromCircle, makeRegular} from '../geom/Polygon';
import PointerInteraction, {handleEvent as handlePointerEvent} from '../interaction/Pointer';
