...
import {distance as coordinateDistance, squaredDistance as squaredCoordinateDistance, closestOnCircle, closestOnSegment, squaredDistanceToSegment} from '../coordinate';
import {listen, unlistenByKey} from '../events';
import EventType from '../events/EventType';
import {boundingExtent, createEmpty} from '../extent';
import {TRUE, FALSE} from '../functions';
import GeometryType from '../geom/GeometryType';
import {fromCircle} from '../geom/Polygon';
import PointerInteraction, {handleEvent as handlePointerEvent} from '../interaction/Pointer';
import {getValues} from '../obj';
import {VectorSourceEvent} from '../source/Vector';
